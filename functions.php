...
if(function_exists("register_field_group"))
{
	register_field_group(array (
		'id' => 'acf_featured-work',
		'title' => 'Featured Work',
		'fields' => array (
			array (
				'key' => 'field_598f4c90eb661',
				'label' => 'Layout',
				'name' => 'layout',
				'type' => 'select',
				'choices' => array (
					'FeaturedWorkLeft' => 'Left Bar',
					'FeaturedWorkRight' => 'Right Bar',
					'FeaturedWorkTop' => 'Top Bar',
				),
				'default_value' => '',
				'allow_null' => 0,
				'multiple' => 0,
